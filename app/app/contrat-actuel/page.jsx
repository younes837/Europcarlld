...
const columns = [
  ...
  { field: "KM", headerName: "Kilométrage", width: 130 ,renderCell: (params) => {
  ...
  { field: "loyer ht", headerName: "Loyer HT", width: 130 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
  ...
  { field: "loyer ttc", headerName: "Loyer TTC", width: 130 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
  ...
  { field: "loyer_global", headerName: "Loyer Global", width: 130 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
  ...
  { field: "VR HT", headerName: "VR HT", width: 130 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
  ...
  { field: "ACH_PX_HT", headerName: "Prix Achat HT", width: 130 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
  ...
  { field: "ACH_PX_TTC", headerName: "Prix Achat TTC", width: 130 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
