...
const columns = [
  ...
  { field: "DERNIER_KM", headerName: "Dernier KM", width: 130 ,renderCell: (params) => {
  ...
  { field: "KM_AFFECTE", headerName: "KM Affecté", width: 130 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
  ...
  { field: "MOYENNE_KM_PAR_JOUR", headerName: "Moyenne KM/Jour", width: 150 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
  ...
  { field: "km_dernier_vidange", headerName: "KM Dernier Vidange", width: 150 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
  ...
  { field: "NEXT_VIDANGE_KM", headerName: "Prochain Vidange KM", width: 150 ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
