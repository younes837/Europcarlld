...
const columns = [
  ...
  { field: "DERNIER_KM", headerName: "Dernier KM", width: 130, type: "number" ,renderCell: (params) => {
  ...
  { field: "KM_AFFECTE", headerName: "KM Affecté", width: 130, type: "number" ,renderCell: (params) => {
  const value = parseFloat(params.value);
  if (isNaN(value)) return "000";
